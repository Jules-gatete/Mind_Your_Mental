...
const Testimonies = () => {
  const [testimonies, setTestimonies] = useState([
    { name: 'Alex', age: 22, content: 'This platform helped me overcome my anxiety. The counseling sessions were life-changing.' },
    { name: 'Sarah', age: 19, content: 'The peer support forums made me feel less alone. I\'ve made great friends here.' },
    { name: 'Michael', age: 25, content: 'The educational resources gave me practical tools to manage my stress. Highly recommended!' },
  ]);
